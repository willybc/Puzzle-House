...
class NivelW inherits Nivel (siguienteNivel = nivel0,permitirAgregarAlAListaDeLnivel0Completado=true){
	...
	const listaCajas=[  new Caja(position = game.at(6,2),resolucion=resolucionCajaW,stringDeObjeto=caja1W,cajaEnMeta=cajaMeta1W,tipo=1,hardCoreTimeBonificacion=4,colorDelTextoDeLaCaja=paleta.rosado())  ,
						 new Caja(position = game.at(7,7),resolucion=resolucionCajaW,stringDeObjeto=caja1W,cajaEnMeta=cajaMeta1W,tipo=1,hardCoreTimeBonificacion=3) ,
						 new Caja(position = game.at(6,9) ,resolucion=resolucionCajaW,stringDeObjeto=caja1W,cajaEnMeta=cajaMeta1W,tipo=1,hardCoreTimeBonificacion=2,colorDelTextoDeLaCaja=paleta.blanco()),
						 ...
						 new Caja(position = game.at(17,7),resolucion=resolucionCajaW,stringDeObjeto=caja1W,cajaEnMeta=cajaMeta1W,tipo=1,hardCoreTimeBonificacion=3,colorDelTextoDeLaCaja=paleta.amarillo()),
						 ...
						 new Caja(position = game.at(8,2),resolucion=resolucionCajaW,stringDeObjeto=caja2W,cajaEnMeta=cajaMeta2W,tipo=2,hardCoreTimeBonificacion=2,colorDelTextoDeLaCaja=paleta.negro()),
